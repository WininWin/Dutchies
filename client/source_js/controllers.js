...
webAppControllers.controller('ItemDetailsController', ['$scope', '$state', '$rootScope', 'CurrentUser', '$stateParams', '$mdDialog',function($scope, $state, $rootScope, CurrentUser, $stateParams, $mdDialog) {
